...
import com.emu.tqqserver.service.PuzzleService;
...
public class PuzzleRoutes extends BaseRoute {
    ...
    public void helperList(ChannelHandlerContext ctx, FullHttpRequest req) {
        ...
        java.util.List<UserEntity> friends = new com.emu.tqqserver.service.FriendService().getFriends(me.getUserId());
    ...
    public void ranking(ChannelHandlerContext ctx, FullHttpRequest req) {
        ...
        java.util.List<UserEntity> allUsers = new com.emu.tqqserver.service.UserService().getAllUsers();
        java.util.List<UserEntity> friends = new com.emu.tqqserver.service.FriendService().getFriends(me.getUserId());
