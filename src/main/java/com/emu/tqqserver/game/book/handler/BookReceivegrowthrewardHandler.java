...
public class BookReceivegrowthrewardHandler extends BaseRoute {

    private static final Logger log = LoggerFactory.getLogger(BookReceivegrowthrewardHandler.class);
    private final UserService userService = new UserService();
    private final StoredDataService storedDataService = new StoredDataService();

    public void handle(ChannelHandlerContext ctx, FullHttpRequest req) {
 log.info("book/receivegrowthreward"); sendNocontent(ctx, req); 
    }
}
