...
public class BookUpdatepictureidxHandler extends BaseRoute {

    private static final Logger log = LoggerFactory.getLogger(BookUpdatepictureidxHandler.class);
    private final UserService userService = new UserService();
    private final StoredDataService storedDataService = new StoredDataService();

    public void handle(ChannelHandlerContext ctx, FullHttpRequest req) {
 log.debug("book/updatepictureidx"); sendNocontent(ctx, req); 
    }
}
