...
public class BookCollectionrewardHandler extends BaseRoute {

    private static final Logger log = LoggerFactory.getLogger(BookCollectionrewardHandler.class);
    private final UserService userService = new UserService();
    private final StoredDataService storedDataService = new StoredDataService();

    public void handle(ChannelHandlerContext ctx, FullHttpRequest req) {
 log.info("book/collectionreward"); sendNocontent(ctx, req); 
    }
}
