...
@Route("/book/exchange")
public class BookExchangeHandler extends BaseRoute {

    private static final Logger log = LoggerFactory.getLogger(BookExchangeHandler.class);
    private final UserService userService = new UserService();
    private final StoredDataService storedDataService = new StoredDataService();

    public void handle(ChannelHandlerContext ctx, FullHttpRequest req) {
 log.info("book/exchange"); sendNocontent(ctx, req); 
    }
}
