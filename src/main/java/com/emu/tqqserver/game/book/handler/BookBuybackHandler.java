...
@Route("/book/buyback")
public class BookBuybackHandler extends BaseRoute {

    private static final Logger log = LoggerFactory.getLogger(BookBuybackHandler.class);
    private final UserService userService = new UserService();
    private final StoredDataService storedDataService = new StoredDataService();

    public void handle(ChannelHandlerContext ctx, FullHttpRequest req) {
 log.info("book/buyback"); sendNocontent(ctx, req); 
    }
}
