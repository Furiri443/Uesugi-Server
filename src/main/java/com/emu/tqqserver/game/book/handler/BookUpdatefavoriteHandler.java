...
public class BookUpdatefavoriteHandler extends BaseRoute {

    private static final Logger log = LoggerFactory.getLogger(BookUpdatefavoriteHandler.class);
    private final UserService userService = new UserService();
    private final StoredDataService storedDataService = new StoredDataService();

    public void handle(ChannelHandlerContext ctx, FullHttpRequest req) {
 log.debug("book/updatefavorite"); sendNocontent(ctx, req); 
    }
}
